...
rm $HOME/.zshrc $HOME/.tmux.conf $HOME/.emacs $HOME/.emacs.d/init.el $HOME/.config/sway/config $HOME/.config/nvim/init.vim $HOME/.local/share/konsole/gruvbox.colorscheme $HOME/.tmux/tmuxline
